...
import com.rocky.orm.PropertyFilter.MatchType;
import com.rocky.util.ReflectionUtils;
...
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
	...
	protected long countCriteriaResult(final Criteria c) {
		...
		// 执行Count查询
		Long totalCountObject = Long.parseLong(c.setProjection(Projections.rowCount()).uniqueResult().toString());
